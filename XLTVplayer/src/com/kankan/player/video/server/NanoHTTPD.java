...
public abstract class NanoHTTPD {
    ...
    public static class DefaultTempFile implements TempFile {
        ...
        public DefaultTempFile(String tempdir) throws IOException {
            AppConfig.LOGD("[[NanoHTTPD]] default tempdir=" + tempdir);
    ...
    public static class Response {
         ...
         * Basic constructor.
         */
        public Response(IStatus status, String mimeType, InputStream data, long dataLen) {
            this.status = status;
        ...
        protected void send(OutputStream outputStream) {
            ...
            try {
                ...
                if (requestMethod != Method.HEAD && chunkedTransfer) {
                    ...
                    long pending = dataLen != 0 ? dataLen : (data != null ? data.available() : 0);
                ...
                AppConfig.LOGD("[[NanoHTTPD]] send IOException:" + ioe.getMessage());
            }
        }

        protected void sendContentLengthHeaderIfNotAlreadyPresent(PrintWriter pw, Map<String, String> header, long size) {
            AppConfig.LOGD("[[NanoHttpd]] sendContentLengthHeaderIfNotAlreadyPresent size=" + size);
